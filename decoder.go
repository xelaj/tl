...
type UnmarshalProvider interface {
...
func (d *Decoder) popCRC() (uint32, error)  { return d.popUint() }
...
func (d *Decoder) provider() UnmarshalProvider { return ptr(unmarshaler(*d)) }

type unmarshaler Decoder

var _ UnmarshalProvider = (*unmarshaler)(nil)
